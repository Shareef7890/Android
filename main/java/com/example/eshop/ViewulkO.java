...
public class ViewulkO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewulk_o);
        lv = findViewById(R.id.listBulkorders);
        btn=(Button) findViewById(R.id.reborders);
        db = FirebaseDatabase.getInstance().getReference();
        // helper = new FirebaseHelper(db);
        adapter = new BulkAdapter(ViewulkO.this, getMyOrders());
